...
class ImageLabelingApp:
    def __init__(self):
        ...
        # Przycisk do uruchomienia aplikacji encyklopedii
        self.encyclopedia_button = tk.Button(self.window, text="Otwórz encyklopedię", command=self.open_encyclopedia)
        self.encyclopedia_button.pack(side=tk.BOTTOM)  # Dodaj ten przycisk na dole
    ...
    def load_config(self):
        ...
        with open('labeling\config.txt', 'r') as f:
            for line in f:
                line = line.strip()
    ...
    def open_encyclopedia(self):
        """Funkcja uruchamiająca aplikację encyklopedii"""
        try:
            subprocess.Popen(["python", "encyclopediaapp.py"])  # Zakładając, że encyklopedia jest w pliku "encyclopedia.py"
        except Exception as e:
            messagebox.showerror("Błąd", f"Nie udało się uruchomić encyklopedii:\n{e}")
